...
const PageLanding = () => {
  return (
    <div className='h-auto md:h-screen flex flex-col font-inter md:flex-row'>
      ...
      <div className='px-5 max-w-[440px] flex flex-col align-middle mx-auto md:w-[548px] justify-center pb-[30px]'>
